...
def encoder_type(encode):
    """
    Pega o valor enviado do menu de codificação do usuário e retorna
o valor real a ser usado.
...
def ms_payload(payload):
    """
  Recebe a entrada dada pelo usuário de create_payload.py
   e create_payloads.py
...
def ms_payload_2(payload):
    """ Recebe a entrada dada pelo usuário de create_payloads.py """
...
def ms_attacks(exploit):
    """ Receber dados do usuário para create_payload.py """
...
def teensy_config(choice):
    """ Receber dados do usuário para set.py """
